...
DATASET_NAME = 'Drilling Data' # Used for report title
INPUT_FILE = 'Data/Drilling/Drilling.csv'
OUTPUT_FILE = 'Data/Drilling/Drilling_Cleaned.csv'
REPORT_FILE = 'Data/Drilling/Drilling_Report.md'
