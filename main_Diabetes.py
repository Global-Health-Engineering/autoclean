...
DATASET_NAME = 'Diabetes Data' # Used for report title
INPUT_FILE = 'Data/Diabetes/Diabetes.csv'
OUTPUT_FILE = 'Data/Diabetes/Diabetes_Cleaned.csv'
REPORT_FILE = 'Data/Diabetes/Diabetes_Report.md'
...
# max_depth = 5, min_samples_leaf = 2, max_iter: int = 15, n_estimators: int = 50
